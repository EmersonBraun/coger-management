...
import FoldersRepository from '../../../Repositories/users/FoldersRepository'
import { FolderSchema } from '../../../Validators/users/FolderSchema'
...
export default class FoldersController {
  ...
  async store ({ request, response }: HttpContextContract) {
    try {
      await request.validate({schema: FolderSchema})
    } catch (error) {
