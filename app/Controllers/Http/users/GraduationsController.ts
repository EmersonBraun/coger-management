...
import GraduationsRepository from '../../../Repositories/users/GraduationsRepository'
import { GraduationSchema } from '../../../Validators/users/GraduationSchema'

export default class GraduationsController {
  private readonly repository
  constructor () {
    this.repository = GraduationsRepository
  }
  ...
  async store ({ request, response }: HttpContextContract) {
    try {
      await request.validate({schema: GraduationSchema})
    } catch (error) {
