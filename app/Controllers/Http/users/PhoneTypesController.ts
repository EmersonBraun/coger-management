...
import PhoneTypesRepository from '../../../Repositories/users/PhoneTypesRepository'
import { PhoneTypeSchema } from '../../../Validators/users/PhoneTypeSchema'

export default class PhoneTypesController {
  private readonly repository
  constructor () {
    this.repository = PhoneTypesRepository
  }
  ...
  async store ({ request, response }: HttpContextContract) {
    try {
      await request.validate({schema: PhoneTypeSchema})
    } catch (error) {
