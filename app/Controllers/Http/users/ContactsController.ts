...
import ContactsRepository from '../../../Repositories/users/ContactsRepository'
import { ContactSchema } from '../../../Validators/users/ContactSchema'
...
export default class ContactsController {
  ...
  async store ({ request, response }: HttpContextContract) {
    try {
      await request.validate({schema: ContactSchema})
    } catch (error) {
