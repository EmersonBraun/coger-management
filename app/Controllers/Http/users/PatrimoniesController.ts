...
import PatrimoniesRepository from '../../../Repositories/users/PatrimoniesRepository'
import { PatrimonieSchema } from '../../../Validators/users/PatrimonieSchema'

export default class PatrimoniesController {
  private readonly repository
  constructor () {
    this.repository = PatrimoniesRepository
  }
  ...
  async store ({ request, response }: HttpContextContract) {
    try {
      await request.validate({schema: PatrimonieSchema})
    } catch (error) {
