...
import RamalsRepository from '../../../Repositories/users/RamalsRepository'
import { RamalSchema } from '../../../Validators/users/RamalSchema'

export default class RamalsController {
  private readonly repository
  constructor () {
    this.repository = RamalsRepository
  }
  ...
  async store ({ request, response }: HttpContextContract) {
    try {
      await request.validate({schema: RamalSchema})
    } catch (error) {
