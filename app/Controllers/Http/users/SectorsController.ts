...
import SectorsRepository from '../../../Repositories/users/SectorsRepository'
import { SectorSchema } from '../../../Validators/users/SectorSchema'

export default class SectorsController {
  private readonly repository
  constructor () {
    this.repository = SectorsRepository
  }
  ...
  async store ({ request, response }: HttpContextContract) {
    try {
      await request.validate({schema: SectorSchema})
    } catch (error) {
