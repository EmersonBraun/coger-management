...
import IpsRepository from '../../../Repositories/users/IpsRepository'
import { IpSchema } from '../../../Validators/users/IpSchema'

export default class IpsController {
  private readonly repository
  constructor () {
    this.repository = IpsRepository
  }
  ...
  async store ({ request, response }: HttpContextContract) {
    try {
      await request.validate({schema: IpSchema})
    } catch (error) {
