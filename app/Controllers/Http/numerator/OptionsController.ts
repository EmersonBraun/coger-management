...
import OptionsRepository from '../../../Repositories/numerator/OptionsRepository'
import { OptionSchema } from '../../../Validators/numerator/OptionSchema'
...
export default class OptionsController {
  ...
  async store ({ request, response }: HttpContextContract) {
    try {
      await request.validate({schema: OptionSchema})
    } catch (error) {
